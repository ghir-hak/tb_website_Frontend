...
<div align="center" style="width: 100%; white-space: nowrap; font-size: 0;"><img src="images/gifs/newproject.gif" style="width: calc(33.33% - 6.67px); border-radius: 15px; margin: 0 5px; display: inline-block; vertical-align: top;"><img src="images/gifs/newfunction.gif" style="width: calc(33.33% - 6.67px); border-radius: 15px; margin: 0 5px; display: inline-block; vertical-align: top;"><img src="images/gifs/pushall.gif" style="width: calc(33.33% - 6.67px); border-radius: 15px; margin: 0 5px; display: inline-block; vertical-align: top;"></div>
...
<div align="center" style="width: 100%; white-space: nowrap; font-size: 0;"><img src="images/gifs/builds.gif" style="width: calc(33.33% - 6.67px); border-radius: 15px; margin: 0 5px; display: inline-block; vertical-align: top;"><img src="images/gifs/runfunction.gif" style="width: calc(33.33% - 6.67px); border-radius: 15px; margin: 0 5px; display: inline-block; vertical-align: top;"></div>
